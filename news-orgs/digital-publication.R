...
", 60)
caption <- glue("Graphic: {get_icon('twitter', 10, fill = list(bg = bg, img = 'black'))} @melysantoso_ / Source: Project Oasis / Code: {get_icon('github', 10, fill = list(bg = bg, img = 'black'))} melysantoso")
fill <- "Number of\npublications"
